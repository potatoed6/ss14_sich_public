...
namespace Content.Server.Ghost
{
    public sealed class GhostSystem : SharedGhostSystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<GhostComponent, SetGhostColorMsg>(SetSponsorGhostColor);
        }

        private void SetSponsorGhostColor(Entity<GhostComponent> ent, ref SetGhostColorMsg args)
        {
