...
public sealed class TetherGunSystem : SharedTetherGunSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<TetherForseCombineComponent, ComponentShutdown>(ShutdownTeherGun);
    }

    private void ShutdownTeherGun(Entity<TetherForseCombineComponent> ent, ref ComponentShutdown args)
    {
